    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container container-xxl">
                <form class="form d-flex flex-column flex-lg-row" novalidate action="{{ route('admin.events.update', $event->id) }}"
                                        ...
                                        <div class="card-body">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title" class="form-control mb-2"
                                                    placeholder="Name of event" value="{{ $event->title }}" required>
                                                <!-- <div class="text-muted fs-7">A event title is required.</div> -->
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="form-label">Short Description</label>
                                                <textarea name="short_description" rows="4" class="form-control mb-2" placeholder="Short Details about event"
                                                    ...
                                                    <div class="mediaFileList">
                                                        ...
                                                        @if ($event->images)
                                                                @foreach ($event->images as $key => $item)
                                                                    <li> <img
                                                                            src="{{ asset('backend/admin/images/event_management/events/' . $event->images[$key]) }}" /><button type="button" class="rm-img-btn" ><span aria-hidden="true">×</span></button>
                                                                            <input type="hidden" name="oldImages[]" value="{{$event->images[$key]}}">
                                                                        </li>
                                                                @endforeach
                                                        @endif
														</ul>
                                            ...
                                            {{-- <div class="row">
                                                    <div class="col-md-12 mb-10">
                                                        ...
                                                        <input type="text" name="location" class="form-control mb-2" value="{{$event->location}}" placeholder="An event venue" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <div class="input-group input-gt">
                                                        <input type="text" class="form-control" name="location"
                                                            value="{{ $event->location }}" placeholder="An event venue"
                                                ...
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <input type="number" name="number_of_tickets" class="form-control mb-2"
                                                        value="{{ $event->number_of_tickets }}"
                                            ...
                                            <div class="row align-items-center">
                                                @foreach ($eventyype as $item)
                                                    <div class="col-md-4 mb-10">
                                                        <label class="required form-label">Types of Ticket</label>
                                                        <input type="text" name="tickettype[]"
                                                            class="form-control mb-2 type-ticket"
                                                            value="{{ $item->title }}" placeholder="Type ticket"
                                                            required>
                                                        <!-- <div class="text-muted fs-7">Set the Number of Ticket.</div> -->
                                                    </div>
                                                    <div class="col-md-4 mb-10">
                                                        <label class="required form-label">Ticket Tag</label>
                                                        <input type="text" name="ticket_tag[]"
                                                            class="form-control mb-2 type-ticket-tag"
                                                            value="{{ $item->tag }}" placeholder="Ticket Tag" required>
                                                        <input type="hidden" name="bigcomm[]"
                                                            value="{{ $item->bigcommerce_id }}" required>
                                                    </div>
                                                    <div class="col-md-3 mb-10">
                                                        <label class="required form-label">Ticket Price</label>
                                                        <input type="number" step="0.01" name="ticket_price[]"
                                                            class="form-control mb-2 type-ticket-price"
                                                            value="{{ $item->ticket_price }}" placeholder="Ticket Price"
                                                            required>
                                                    </div>

                                                    <div class="col-md-1 mb-10 mt-4 cursor-pointer"
                                                        onclick="closeType(this)">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="checkbox" name="single_day" id="single_day"
                                                            onclick="showDateDiv()"
                                                            @if ($event->single_day == '1') checked @endif>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-10 multiple_day d-none">
                                                            ...
                                                            <input type="date" name="end_date"
                                                                class="form-control mb-2" value="{{ $event->end_date }}">
                                                            <!-- <div class="text-muted fs-7">Select Event Date.</div> -->
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        class="col-md-12 d-flex gap-2 align-self-center justify-content-end">
                                                        <input type="checkbox" name="all_day" id="all_day" onclick="showTimeDiv()" @if ($event->all_day == '1') checked @endif>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-2 all_day">
                                                            ...
                                                            <input type="time" name="end_time"
                                                                class="form-control mb-2" value="{{ $event->end_time }}">
                                                    ...
                                                    <select class="form-select mb-2" name="category_ids[]"
                                                        ...
                                                        @foreach ($event_categories as $event_categorie)
                                                            <option value="{{ $event_categorie->id }}"
                                                                @if (in_array($event_categorie->id, $event->category_ids)) selected @endif>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-5">
                                                    ...
                                                    <input type="text" name="seo_title" class="form-control mb-2"
                                                        value="{{ $event->seo_title }}" placeholder="Name of title">
                                                </div>
                                                <div class="col-md-12">
                                                    <label class="form-label">Seo Description</label>
                                                    <textarea name="seo_description" class="form-control mb-2" rows="4" placeholder="SEO Details">{{ $event->seo_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

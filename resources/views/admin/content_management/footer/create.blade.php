...
<style>
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="custom-app-toolbar">
            ...
            <div class="right">
                {{-- <a href="{{ route('admin.users.create') }}" class="pb-btn btn-prev">
        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container container-xxl">
                <form class="form" action="{{ route('admin.footers.store') }}" id="form_id" method="POST"
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100">
                        ...
                        <div class="card card-flush">
                            <div class="card-body">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="title" class="form-control mb-2" placeholder="Footer Name"
                                        required>
                                </div>
                        ...
                        <div class="card card-flush">
                            <div class="card-body">
                                <div class="fv-row">
                                    <div class="d-flex fv-row content">
                                        <div class="w-100">
                        ...
                        <div class="card card-flush">
                            <div class="card-body">
                                ...
                                <div class="fv-row mt-5 d-none global_title-content">
                                    ...
                                    <textarea id="editor" name="global_title_text"></textarea>
                        ...
                        <div class="card card-flush">
                            <div class="card-body">
                                ...
                                <div class="fv-row">
                                    ...
                                    <textarea id="editor1" name="sub_title"></textarea>
                                </div>

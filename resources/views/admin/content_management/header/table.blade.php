        ...
        @foreach ($headers as $key => $header)
            <tr>
                ...
                <td>
                    ...
                    @else
                        <a href="{{ route('admin.headers.show', $header->id) }}?status=1">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-more-details menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4 mt-10 new-dp1 dropdown-menu"
                            ...
                            <div class="menu-item px-3">
                                ...
                                @endcan
                                @can('header-delete')
                                <a class="menu-link px-3" onclick="confirmDelete({{$header->id}})">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
...
<div class="row">
    <div class="col-md-4">
        <p>
            <b>Showing {{ ($headers->currentpage() - 1) * $headers->perpage() + 1 }} to
                {{ ($headers->currentpage() - 1) * $headers->perpage() + $headers->count() }} of

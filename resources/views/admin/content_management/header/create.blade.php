    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container container-xxl">
                <form class="form" action="{{ route('admin.headers.store') }}" method="POST"
                        ...
                        <div class="card card-flush">
                            <div class="card-body">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="title" class="form-control mb-2" placeholder="Header Name"
                                        required>
                                </div>
                                <div class="w-150px">
                            ...
                            <div class="card-body">
                                <div class="fv-row">
                                    <div class="d-flex fv-row mb-10">
                                        <div class="w-100">
                                            {{-- <input class="form-check-input me-3 radio-accordion" data-content="background-image-content" name="background_type" value="image" type="radio" id="background_type_image" />
                                            ...
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                <!--begin::Input-->
                                                <input class="form-check-input radio-accordion"
                                                    data-content="background-image-content" name="background_type"
                                                    type="checkbox" value="image" id="kt_modal_add_customer_billing"
                                                    checked="checked" />
                                                <!--end::Input-->
                                                <!--begin::Label-->
                                                <span class="form-check-label fw-semibold text-muted"
                                                    for="kt_modal_add_customer_billing">Background Image</span>
                                                <!--end::Label-->
                                            </label>
                                        </div>
                                    </div>
                                    <div
                                        class="d-flex fv-row mb-10 px-11 d-none radio-accordion-content background-image-content">
                                        <div class="w-100">
                                            ...
                                            <div class="mediaFileList mediaFileList-backimg"></div>
                                        </div>
                                    </div>
                                    <div class="d-flex fv-row">
                                        <div class="w-100">
                                            {{-- <input class="form-check-input me-3 radio-accordion" data-content="background-color-content" name="background_type" value="color" type="radio" id="background_type_color" />
                                            ...
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                ...
                                                <input class="form-check-input radio-accordion"
                                                    ...
                                                    type="checkbox" value="color" id="kt_modal_add_customer_billing"
                                                    checked="checked" />
                                                <!--end::Input-->
                                                <!--begin::Label-->
                                                <span class="form-check-label fw-semibold text-muted"
                                                    for="kt_modal_add_customer_billing">Background color</span>
                                                <!--end::Label-->
                                            </label>
                                        </div>
                                    </div>
                                    <div
                                        class="d-flex fv-row mb-10 px-11 mt-10 d-none radio-accordion-content background-color-content">
                                        <div class="w-100">
                                            <p class="fw-bold text-gray-800 mb-1 fs-5">Enabled featured image</p>
                                            <p class="text-gray-500 mb-10">Choose or upload an image to be used when sharing
                                                your page on header background</p>
                                ...
                                <div class="fv-row">
                                    ...
                                    <div class="d-flex fv-row px-11 mt-10 d-none default_logo-content">
                                        <div class="w-100">
                                            ...
                                            <div class="mediaFileList mediaFileList-d-logo"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>

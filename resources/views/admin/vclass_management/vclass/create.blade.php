    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container container-xxl">
                <form id="form01" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.vclasses.store') }}"
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        <div class="tab-content">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title"
                                                    ...
                                                    oninput="validate(this, 'title-warn')" placeholder="Title of Class"
                                                    required>
							...
							<textarea name="description" rows="4" id="editor" class="form-control form-control11 mb-2" placeholder="Text here"></textarea>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <textarea class="form-control11 form-control" placeholder="Text here"  id="editor1" name="prerequisites"></textarea>
											...
											<div class="row mb-5">
												...
												<div class="col-md-6">
													...
													<div class="mediaFileList1"><ul></ul></div>
                                                </div>
											</div>
												<div class="row">
													<div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
													 <div class="col-md-12 mb-2 all_day">
                                                            ...
                                                            <input type="text" name="class_length" placeholder="Duration in hour or minutes" class="form-control mb-2 form-control11 required">
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="checkbox" name="free_class" id="free_class"
                                                            onclick="showTimeDiv()">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-5">
                                                    ...
                                                    <input type="text" name="instruct_name"
                                                        class="form-control mb-2 form-control11 title_can"
                                                        placeholder="Name">
                                                </div>
                                                <div class="col-md-12">
                                                    <label class="form-label">Bio</label>
                                                    <textarea name="instruct_bio" class="form-control title_can1  mb-2 form-control11" rows="4" placeholder="Bio here"></textarea>
                                                </div>
												 </div>
												<div class="col-md-5 mb-12">
													...
													<div class="mediaFileList2"><ul></ul></div>

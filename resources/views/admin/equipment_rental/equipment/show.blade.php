                ...
                <div class="card-body card-bfg11">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <ul class="event-gallery-main slick-initialized slick-slider" id="event-gallery-main">
                                <div aria-live="polite" class="slick-list draggable">
                                    <div class="slick-track"
                                        style="opacity: 1; width: 204px; transform: translate3d(0px, 0px, 0px);"
                                        role="listbox">
                                        <li class="slick-slide slick-current slick-active" data-slick-index="0"
                                            aria-hidden="false" style="width: 204px;" tabindex="-1" role="option"
                                            aria-describedby="slick-slide00"><img class="event-image"
                            ...
                            <div class="event-gallery-parent">
                                <ul class="event-gallery mt-5 slick-initialized slick-slider" id="event-gallery">
                                    <div aria-live="polite" class="slick-list draggable">
                                        <div class="slick-track"
                                            style="opacity: 1; width: 68px; transform: translate3d(0px, 0px, 0px);"
                                            role="listbox">
                                            <li class="slick-slide slick-current slick-active" data-slick-index="0"
                                                aria-hidden="false" style="width: 68px;" tabindex="-1" role="option"
                                                aria-describedby="slick-slide10"><img class="event-image-gallery"
                                                    src="https://admin.fairchildfun.com/backend/admin/images/event_management/events/18501866371696011728.jpg"
                        ...
                        <div class="col-md-7 event_coniy">
                            <div class="event-content">
                                ...
                                <h1 class="redwood">Redwood Retreat Cabin</h1>
                                <span class="camping">Camping</span>
                                <p class="evt-short-description mt-2 evt1_short evt1_short1">The Historic Inn at
                                    Willowbrook is a captivating piece of history in the heart of a quaint, historic
                                    town.</p>

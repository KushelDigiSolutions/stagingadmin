...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div class="app-content flex-column-fluid">
        <div class="app-container container-xxl">
            <form id="form01" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.equipment.update',$equipment->id ) }}" method="POST"
                                        ...
                                        <div class="row">
                                                    ...
                                                    <select class="form-select mb-2 form-control11" name="category_ids[]"
                                                        ...
                                                        @foreach ($equipment_categories as $category)
														 <option value="{{ $category->id }}"
                                                                @if (in_array($category->id, $equipment->category_ids)) selected @endif>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    @for ($i = 1; $i <= 100; $i++)
                                                        <option value="{{ $i }}"  @if ($i == $equipment->stock) selected @endif>{{ $i }}</option>
                                                    @endfor
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <label class="lbl-eventMedia" for="eventMedia">
                                                    ...
                                                    <div class="mediaFileList">
                                                        ...
                                                        @if ($equipment->images)
                                                                ...
                                                                @foreach ($equipment->images as $key => $item)
                                                                    <li> <img
                                                                            src="{{ asset('backend/admin/images/equipment_management/equipments/' . $equipment->images[$key]) }}" /><button type="button" class="rm-img-btn" ><span aria-hidden="true">×</span></button>
                                                                            <input type="hidden" name="oldImage[]" value="{{$equipment->images[$key]}}">
                                                                        </li>
                                                                @endforeach
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 mt-5">
                                                        ...
                                                        <input name="price"  value="{{ $equipment->price }}" placeholder="Per day charges" class="form-control form-control11 formis_cant" type="text">
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 mt-5">
                                                        ...
                                                        <input name="start_date"  value="{{ $equipment->start_date }}" class="form-control form-control11 formis_cant" type="date">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-12 mt-5">
                                                            ...
                                                            <input name="security_price"  value="{{ $equipment->security_price }}" placeholder="Security Charges" class="form-control form-control11 formis_cant" type="text">
                                                        </div>
                                                    </div>
                                        </div>
                                        <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-12 mt-5">
                                                            ...
                                                            <input name="delivery_price"  value="{{ $equipment->delivery_price }}" placeholder="Delivery and Pickup Charges" class="form-control form-control11 formis_cant" type="text">
                                                        </div>
                                                    </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card card-flush">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-12 fv-row">
                                            ...
                                            value="{{ $equipment->location_frame }}"
                                                class="form-control title_can form-control11 mb-2"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="seo_description" class="form-control mb-2 form-control11 title_can1" rows="4" placeholder="SEO Details">{{ $equipment->seo_description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>

...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div class="app-content flex-column-fluid">
        <div class="app-container container-xxl">
            <form id="form01" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.lodging.update', $lodging->id) }}" method="POST"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active">
                            <div class="d-flex flex-column gap-7 gap-lg-10">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <select
                                                        class="form-select form-control title_can form-control11  form-select-lg form-select-solid"
                                                        data-control="select2"  name="category_ids[]" data-placeholder="Select an option"
                                                        data-allow-clear="true" multiple="multiple">
                                                        @foreach ($lodging_categories as $category)
														 <option value="{{ $category->id }}"
                                                                @if (in_array($category->id, $lodging->category_ids)) selected @endif>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <input type="text" name="location"
                                                        ...
                                                        class="form-control title_can form-control11 mb-2"
                                                        oninput="validate(this, 'title-warn')" placeholder="Address for this Location" required="">
                                                    <div id="title-warn" class="text-warning2 none fs-7">Please add the location</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-7">
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <textarea placeholder="Text here"
                                                        ...
                                                        name="description">{{ $lodging->description }}</textarea>
                                                ...
                                                <div class="mediaFileList">
                                                        ...
                                                        @if ($lodging->images)
                                                                ...
                                                                @foreach ($lodging->images as $key => $item)
                                                                    <li> <img
                                                                            src="{{ asset('backend/admin/images/lodging/' . $lodging->images[$key]) }}" /><button type="button" class="rm-img-btn" ><span aria-hidden="true">×</span></button>
                                                                            <input type="hidden" name="oldImage[]" value="{{$lodging->images[$key]}}">
                                                                        </li>
                                                                @endforeach
                                ...
                                <div class="card card-flush">
                                    <div class="card-body">
                                        <h1 class="room_details">Room Details</h1>
                                        <div class="row mt-6">
                                            <div class="col-md-2">
                                                <label class="form-label form">Room Price</label>
                                                <div class="input-group mb-5">
                                                    <span class="input-group-text">$</span>
                                                    <input type="text" value="{{ $lodging->price }}" class="form-control title_can form-control11" name="price"
                                                        aria-label="Amount (to the nearest dollar)" />
                                                    <span class="input-group-text">/night</span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label form">Check in</label>
                                                <div class="input-group" id="kt_td_picker_localization"
                                                    data-td-target-input="nearest" data-td-target-toggle="nearest">
                                                
                                                    <input type="date" name="check_in" value="{{ $lodging->check_in }}" class="form-control title_can form-control11"
                                                        data-td-target="#kt_td_picker_localization" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label form">Check out</label>
                                                <div class="input-group" id="kt_td_picker_localization1"
                                                    data-td-target-input="nearest" data-td-target-toggle="nearest">
                                                   
                                                    <input type="date" name="check_out" value="{{ $lodging->check_out }}" class="form-control title_can form-control11"
                                                        data-td-target="#kt_td_picker_localization" />
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label form">Room Capacity</label>
                                                <select name="room_capacity" class="form-select form-control title_can form-control11"
                                                    data-placeholder="Select an option" id="capacity">
                                                    <option value="0">Select Capacity</option>
                                                    @for ($i = 1; $i <= 20; $i++)
                                                        <option value="{{ $i }}"  @if ($i == $lodging->room_capacity) selected @endif>{{ $i }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label form">Room Type</label>
                                                <select name="room_type_id" class="form-select form-control title_can form-control11"
                                                    data-placeholder="Select an option" id="room_type_id">
                                                    <option value="0">Select Room</option>
                                                    @foreach($rooms as $room)
                                                            <option value="{{ $category->id }}"
                                                                @if ($room->id == $lodging->room_type_id) selected @endif>
                                                                {{ $room->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div class="card card-flush">
                                    <div class="card-body">
                                        <h2 class="am">Amenities</h2>
                                            <div class="row mt-6 rw11">
                                                    @foreach ($aminities as $amanity)
                                                        <div class="col-md-3">
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <input class="form-check-input" type="checkbox" name="amanities[]" value="{{$amanity->id}}" 
                                                                    id="flexCheckDefault[]"   @if (in_array($amanity->id, $lodging->aminities_ids)) checked @endif />
 ...
 <div class="card card-flush">
                                    <div class="card-body">
                                        <h2 class="am">Features</h2>
                                        <div class="row mt-6 rw11">
                                        @foreach ($features as $feature)
                                            <div class="col-md-3">
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="checkbox" name="features[]" value="{{$feature->id}}"
                                                            id="flexCheckDefault1[]"  @if (in_array($feature->id, $lodging->feature_ids)) checked @endif />
                                                        <label class="form-check-label" for="flexCheckDefault">
                                                        {{$feature->name}}
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-5">
                                                    ...
                                                    <input type="text" name="seo_title" value="{{ $lodging->seo_title }}"
                                                        class="form-control title_can mb-2 form-control11"
                                                        placeholder="Name of title">
                                                </div>
                                                <div class="col-md-12">
                                                    <label class="form-label">Seo Description</label>
                                                    <textarea name="seo_description" class="form-control mb-2 form-control11 title_can1" rows="4" placeholder="SEO Details">{{ $lodging->seo_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

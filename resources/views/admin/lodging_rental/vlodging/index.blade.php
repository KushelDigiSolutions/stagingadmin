		...
		<!--begin::Toolbar-->
            <div class="custom-app-toolbar">
                ...
                <div class="right">
                    ...
                    <!--end::Menu This Week-->
                        <a href="{{ route('admin.lodging.create') }}" class="btn btn-sm fw-bold btn-primary">
                    ...
                    <div class="card-body" id="page-section-body">
                        ...
                        <form id="search_form">
                            ...
                            <div class="page-section-head">
                                <div class="psh-left">
                                    <p>Rent cabins or Campsites</p>
                                </div>
                                <div class="psh-right d-flex gap-5">
                                    
                                    {{-- <button class="paste"><span>Paste</span> <svg width="18" height="20" viewBox="0 0 18 20"
                                    ...
                                    <div class="d-flex align-items-center position-relative">
                                        <input type="text" class="form-control form-control-solid w-350px ps-13"
                                            name="search_key" placeholder="Rent cabins or Campsites" onkeyup="fillter()">
                        ...
                        <div id="table">
                            @include('admin.lodging_rental.vlodging.table')
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        function toggleActive(id, button) {
           var csrfToken = "{{ csrf_token() }}";
            ...
            $.ajax({
                url: '{{env('APP_URL') }}admin/lodging/toggle-active/' + id,
                type: 'POST',
                dataType: 'json',
                data: {

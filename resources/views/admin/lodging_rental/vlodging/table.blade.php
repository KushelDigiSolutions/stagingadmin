                ...
                <div class="inner-content">
                    ...
                    <div class="image" style="overflow: hidden">
                        ...
                        @if (!empty($vclass->images))
                                ...
                                <div id="carsoulE{{ $key }}" class="carousel slide">
                                    <div class="carousel-inner">
                                        ...
                                        @foreach ($vclass->images as $vkey => $vimg)
                                            <div
                                                class="carousel-item carsoul{{ $key }} @if ($vkey == 0) active @endif">
                                                <img src="{{ asset('backend/admin/images/lodging_rental/vclasss/' . $vimg) }}"
                            ...
                            @else
                                <img class="img_gen11"
                                    src="{{ asset('backend/admin/images/lodging/' . $vclass->images[0]) }}"
                    ...
                    <div class="content">
                        <div class="content-inner">
                            ...
                            <h4>{{ $vclass->title }}</h4>
                            <span class="evt-location evt-location11 mt-2">
                                {{ $vclass->location }}
                            </span>
                ...
                <div class="event-action">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-more-details menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4 mt-10 new-dp1 dropdown-menu"
                            id="self_car_{{ $key }}" aria-labelledby="self_car_{{ $key }}">
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">

                                <a href="{{ route('admin.lodging.edit', $vclass->id) }}"
                                ...
                                <a href="{{ route('admin.lodging.show', $vclass->id) }}"
                                    class="menu-link px-3">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                @can('lodging-delete')
                                        <a class="menu-link px-3" onclick="confirmDelete({{ $vclass->id }})">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                        ...
                                        <form action="{{ route('admin.lodging.destroy', $vclass->id) }}"
                                            id="delete_form_{{ $vclass->id }}" method="POST">
                                            @method('DELETE')
                                            @csrf
                                        </form>
                                    @endcan

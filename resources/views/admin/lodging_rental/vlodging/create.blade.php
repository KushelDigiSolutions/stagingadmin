...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div class="app-content flex-column-fluid">
        <div class="app-container container-xxl">
            <form id="form01" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.lodging.store') }}" method="POST"
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($vclass_categories as $category)
                                        ...
                                        <div class="row mt-6">
                                            <div class="col-md-2">
                                                ...
                                                <div class="input-group mb-5">
                                                    ...
                                                    <input type="text" class="form-control title_can form-control11" name="price"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group" id="kt_td_picker_localization"
                                                    ...
                                                    <input type="date" name="check_in" class="form-control title_can form-control11"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group" id="kt_td_picker_localization1"
                                                    ...
                                                    <input type="date" name="check_out" class="form-control title_can form-control11"
                                                        data-td-target="#kt_td_picker_localization" />
                                                </div>
                                            </div>
                                            <div class="col-md-2">

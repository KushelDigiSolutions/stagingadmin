                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="text-muted fs-7">Set the State status.</div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card card-flush py-4">
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                <label class="required form-label">State CODE</label>
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                <label class="required form-label">State Name</label>
                                                <input type="text" name="name" class="form-control mb-2"
                                                    placeholder="State Name..." required>
                                                <div class="fs-7" style="color:red">A State name is required and
                                                    recommended to be unique.</div>
                                            </div>

        ...
        <div class="app-toolbar py-3 py-lg-6">
            <div class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    @can('states-create')
                        <a href="{{ route('admin.states.create') }}" class="btn btn-sm fw-bold btn-primary">Create New
                            state</a>
                    @endcan
                </div>
            </div>
            ...
            <div class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-body pt-0">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center position-relative mt-10 mb-10">
                                        <input type="text" class="form-control form-control-solid w-250px ps-13"
                                            name="search_key" placeholder="Search state" onkeyup="fillter()">
                        ...
                        <div id="table">
                            @include('admin.lodging_rental.state.table')
                        </div>
                    </div>
                </div>
            </div>

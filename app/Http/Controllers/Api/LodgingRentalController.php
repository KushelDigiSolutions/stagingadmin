...
class LodgingRentalController extends Controller
{
	 ...
	 public function getLodgingHome()
    {
        ...
        $data["image_path"] = url("/backend/admin/images/lodging/"); 
    ...
    public function getLodgingByCategory(Request $request, $slug)
    {
        ...
        foreach ($categories as $category) {
            $category->image = asset('backend/admin/images/lodging/categories/' . $category->image);
        ...
        if ($id) {
            ...
            $dataArray['category']['image'] = asset('backend/admin/images/lodging/categories/' . $id->image);
